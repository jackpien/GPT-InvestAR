...
def get_all_tickers():
    ...
    ticker_list = list(
        set(ticker_list_500 + ticker_list_400 + ticker_list_600))
    return ticker_list
...
def main(args):
    ...
    for i, ticker in enumerate(ticker_list):
        ...
        fmp_10k_url = 'https://financialmodelingprep.com/api/v3/sec_filings/{}?type=10-K&page=0&apikey={}'.format(
            ticker, config_dict['financial_modelling_prep_api_key'])
        ...
        for d in json.loads(response.content):
            ...
            save_path_directory = os.path.join(
                config_dict['annual_reports_html_save_directory'], ticker, date)
